<html>
	...
	<body>
		...
		//If the username and password is found in the database, the details are saved to the session
		if ($count >= 1) {
		...
		//If the username and password is not found in the database the user gets a warning below
		else {
